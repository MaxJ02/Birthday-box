...
const int bassLedPin = A1;  // bass led signal pin (aka A1)
const int rythmLedPin = A3;  // rythm led signal pin (aka A3)
const int soloLedPin = A5;  // solo led signal pin (aka A5)
...
void setup(void)
{
  pinMode(A0, OUTPUT); // led ground pin (aka A0)
  pinMode(A2, OUTPUT); // led ground pin (aka A2)
  pinMode(A4, OUTPUT); // led ground pin (aka A4)
  ...
  pinMode(8, OUTPUT);  // rythm buzzer ground pin 

  solo.begin(5);  // solo buzzer signal pin
  bass.begin(11);  // bass buzzer signal pin
